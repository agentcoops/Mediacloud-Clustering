...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{CLUSTER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{CLUSTER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
cluster_server.pl - Catalyst Testserver

=head1 SYNOPSIS

cluster_server.pl [options]
